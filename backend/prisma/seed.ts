...
async function main() {
  ...
  // Package handlers (pickup + delivery)
  const pickupRoleId = await prisma.roleDescription.findUnique({
    where: { name: 'pickupman' },
  });
  ...
  await prisma.user.upsert({
    ...
    create: {
      ...
      roles: {
        create: {
          role: { connect: { id: pickupRoleId.id } },
        },
      },
      fieldPackageHandler: {
        create: {
  ...
  await prisma.user.upsert({
    ...
    create: {
      ...
      roles: {
        create: {
          role: { connect: { id: deliveryRoleId.id } },
        },
      },
      fieldPackageHandler: {
        create: {
