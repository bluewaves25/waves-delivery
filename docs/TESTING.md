...
| 1.7 | Or open `/track/DEMO-TRACK-001` directly | Same result — **vertical green timeline** + **Customer and order details** sidebar |
| 1.7b | Timeline steps | Connected dots/line, messages + timestamps (README style) |
| 1.7c | Live indicator | “Live updates on” when Socket.IO connects to `/realtime` |
...
## 4b. Realtime tracking UI

| # | Action | Expected |
|---|---|---|
| 4b.1 | Open `/track/DEMO-TRACK-001` | Green vertical timeline with checkmarks + details sidebar |
| 4b.2 | Sidebar fields | Parcel ID, status, customer, area, placed at |
| 4b.3 | Socket | “Live updates on” when connected to API `/realtime` |
| 4b.4 | Merchant `/parcel-tracking?parcelNumber=…` | Same timeline UI; nav brand **SendGH** |
| 4b.5 | With track page open, admin assign or rider deliver | New timeline row appears without refresh |
